...
<div class="btn-group dropleft">
    ...
    <div class="dropdown-menu dropdown-menu-right shadow" style="">
        ...
        @if( count($gf = \AmplifyCode\AscentCMS\Models\SavedFilter::byUrl('/'.request()->path())->global()->get()) > 0)
        ...
        @if( count($pf = \AmplifyCode\AscentCMS\Models\SavedFilter::byUrl('/'.request()->path())->private()->get()) > 0)
